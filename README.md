...
A portfolio of data science projects demonstrating proficiency in data wrangling, pipeline development, statistical analysis, and exploratory data analysis using Python and pandas.
...
**Note:** Individual project READMEs contain detailed methodology, data dictionaries, and project-specific insights.
