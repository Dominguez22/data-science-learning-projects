...
Para este proyecto trabajarás con datos de Instacart. El conjunto de datos fue reducido y modificado respecto al original; se añadieron valores ausentes y duplicados manteniendo las distribuciones para facilitar el trabajo y el aprendizaje. Tu misión es limpiar los datos y preparar un informe con conclusiones sobre los hábitos de compra.
